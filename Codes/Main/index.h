...
<!-- ======================== Tlačítka ======================== -->
  ...
  <div align="center">
      ...
      height:45px; width:25%; margin-top:25px;">&laquo; Table of values </button>
      
      <button type="button" onclick="return show('Page2','Page1');" style="margin:2%;
      height:45px; width:25%; margin-top:25px;"> Manual control &raquo;</button>
  ...
  <div id="demo" align="center">
      ...
      height:45px; width:45%; margin-top:40px;">Start</button>
      <button type="button" onclick="sendData(1)" style="margin:1%;
      height:45px; width:45%; margin-top:40px;">Pause</button>
  </div>
...
<!-- ======================== Tlačítko download ======================== -->
  <div id="buttonD" align="center">
      <button style="margin:2%; height:35px; width:90%; margin-top:25px;" onclick="exportTableToCSV('data.csv')">Export Table Data To Excel File</button>
   </div>
